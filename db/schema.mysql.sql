...
CREATE TABLE IF NOT EXISTS categories (
  ...
  cover_product_external_id VARCHAR(120) NULL,
...
CREATE TABLE IF NOT EXISTS products (
  id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  external_id VARCHAR(120) NOT NULL,
  template_product_external_id VARCHAR(120) NULL,
  name VARCHAR(190) NOT NULL,
  slug VARCHAR(190) NOT NULL,
  sku VARCHAR(100) NOT NULL,
  cat_label VARCHAR(150) NULL,
  essence_name VARCHAR(150) NULL,
  family_name VARCHAR(150) NULL,
  legacy_category_slug VARCHAR(180) NULL,
  short_description TEXT NULL,
  ...
  reviews_label VARCHAR(100) NULL,
  default_length VARCHAR(100) NULL,
  available_lengths_json JSON NULL,
  length_prices_json JSON NULL,
  default_drying VARCHAR(100) NULL,
  available_drying_durations_json JSON NULL,
  humidity_label VARCHAR(100) NULL,
  origin_label VARCHAR(190) NULL,
  calorific_value_label VARCHAR(190) NULL,
  image_key VARCHAR(120) NULL,
  image_url LONGTEXT NULL,
  gallery_keys_json JSON NULL,
...
CREATE TABLE IF NOT EXISTS customers (
  ...
  lifetime_amount DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  advisor_name VARCHAR(190) NULL,
  season_history_json JSON NULL,
  next_delivery_slots_json JSON NULL,
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  currency CHAR(3) NOT NULL DEFAULT 'EUR',
  status ENUM('pending', 'paid', 'processing', 'shipped', 'completed', 'cancelled', 'refunded', 'partial_refund') NOT NULL DEFAULT 'pending',
  ...
  fulfillment_status ENUM('pending', 'scheduled', 'ready', 'delivery', 'completed', 'cancelled', 'returned') NOT NULL DEFAULT 'pending',
  fulfillment_label VARCHAR(120) NULL,
  ...
  delivery_truck VARCHAR(120) NULL,
  ...
  internal_note_title VARCHAR(190) NULL,
...
CREATE TABLE IF NOT EXISTS order_items (
  ...
  selected_drying VARCHAR(100) NULL,
  quantity INT UNSIGNED NOT NULL,
  unit_price DECIMAL(10,2) NOT NULL,
  tax_amount DECIMAL(10,2) NOT NULL DEFAULT 0.00,
  discount_amount DECIMAL(10,2) NOT NULL DEFAULT 0.00,
